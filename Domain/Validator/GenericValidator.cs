...
namespace HallBookingBhatPara.Model.Validator
{
	...
	public class EditUserValidator : GenericValidator<EditUserDto>
	{
	...
	public class InsertConfirmBookHallForCounterAdminValidator : GenericValidator<InsertUserConfirmhallForCounterAdminDTO>
	{
		public InsertConfirmBookHallForCounterAdminValidator()
		{
			RuleFor(x => x.catId)
			 .GreaterThan(0).WithMessage("Category is required.");
			...
			RuleFor(x => x.MrNumber)
				.NotEmpty().WithMessage("MrNumber is required.")
				.MaximumLength(100).WithMessage("MrNumber name cannot exceed 100 characters.");
